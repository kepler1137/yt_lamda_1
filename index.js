...
(async () => {
    ...
    if (directos_live.length > 0) {
        console.log("antes browser");
        let browser = null;
        console.log("despues de browser, antes de config browser");
        ...
        browser = await chromium.puppeteer.launch({
            ...
            ignoreHTTPSErrors: true, // agregado por mi
        });
        */
        ...
        console.log("despues de config browser");
